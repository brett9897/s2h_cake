$(document).ready(function(){
	oTable = $("#clientsResults").dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": global.base_url + "/s2h_cake/clients/dataTables.json",            //dataTables.json is really dataTables.ctp and is is /app/webroot/ putting the .json tells CakePHP to remove all its html visual wrappers.
