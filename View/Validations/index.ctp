<div class="validations index">
	...
	<tr>
		...
		<td><?php echo h($validation['Validation']['label']); ?>&nbsp;</td>
		<td><?php echo h($validation['Validation']['regex']); ?>&nbsp;</td>
		<td><?php echo h($validation['Validation']['created']); ?>&nbsp;</td>
		<td><?php echo h($validation['Validation']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $validation['Validation']['id']), null, __('Are you sure you want to delete # %s?', $validation['Validation']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
