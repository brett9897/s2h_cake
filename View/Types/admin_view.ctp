...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Validation 1'); ?></th>
		<th><?php echo __('Validation 2'); ?></th>
		<th><?php echo __('Validation 3'); ?></th>
		<th><?php echo __('Validation 4'); ?></th>
	...
	<?php
		...
		<tr>
			...
			<td><?php echo $question['validation_1']; ?></td>
			<td><?php echo $question['validation_2']; ?></td>
			<td><?php echo $question['validation_3']; ?></td>
			<td><?php echo $question['validation_4']; ?></td>
			<td class="actions">
